            ...
            document.getElementById('main-balance').innerText = newBalance;
               ...
               transactionDiv.innerHTML = `
                   <div class = "flex items-center gap-2">
                       ...
                       <p class="text-md text-green-500">BDT ${payBillAmount.toFixed(2)} paid for ${paymentList}</p>
                       <p class="text-sm text-black text-sm">Payment successful! Remaining Balance is BDT: ${newBalance.toFixed(2)}</p>
                   </div>`;
