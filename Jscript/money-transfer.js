    ...
    const transactionDiv = document.createElement('div');
            ...
            transactionDiv.innerHTML = `
                <div class = "flex justify-between items-center gap-1">
                    ...
                    <div class="flex-1">
                    <p class="text-md"><span class ="font-bold text-green-600">Money Transfer to${userAccountNumber}</span> BDT: ${transferMoneyAmount.toFixed(2)} was successful, and your new balance is BDT: ${newBalance.toFixed()}.</p>
