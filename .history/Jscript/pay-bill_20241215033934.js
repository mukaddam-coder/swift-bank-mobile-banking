            ...
            document.getElementById('main-balance').innerText = newBalance;
               ...
               transactionDiv.innerHTML = `
                   <div class = "flex items-center gap-2">
                       <p><i class="fa-solid fa-wallet text-2xl text-yellow-500 rounded-full bg-slate-200 p-3"></i></p>
                       <h2 class="p-2 font-bold text-lg">${paymentList}</h2>
                       <p class="text-md">BDT ${payBillAmount} paid for ${paymentList}</p>
                       <p class="text-sm text-gray-600">Payment successful! Remaining Balance: BDT ${newBalance}</p>
                   </div>`;
