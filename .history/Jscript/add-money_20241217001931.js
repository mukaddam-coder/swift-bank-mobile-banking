       ...
       const transactionDiv = document.createElement('div');
               ...
               transactionDiv.innerHTML = `
                   <div class = "flex justify-between items-center gap-1">
                       ...
                       <div class="flex-1">
                       <p class="text-md"><span class ="font-bold text-green-600">From ${bankList}</span> BDT: ${addMoney.toFixed(2)} was added to your account, and your new balance is BDT: ${newBalance.toFixed}</p>
