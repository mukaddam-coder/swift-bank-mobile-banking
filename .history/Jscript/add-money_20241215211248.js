        ...
        transactionDiv = document.createElement('div');
               ...
               transactionDiv.innerHTML = `
                   <div class = "flex items-center gap-1">
                       ...
                       <h2 class="p-1 font-bold text-lg">${bankList}</h2>
                       <p class="text-md"><span class="font-bold">Deposit</span><span class ="font-bold text-green-600">From ${bankList}</span> BDT: ${addMoney} was added to your account, and your new balance is BDT: ${newBalance}</p>
