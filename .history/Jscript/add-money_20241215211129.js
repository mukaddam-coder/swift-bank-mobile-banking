        ...
        transactionDiv = document.createElement('div');
               ...
               transactionDiv.innerHTML = `
                   <div class = "flex items-center gap-1">
                       ...
                       <p class="text-md">Deposit<span class ="font-bold text-green-600">From ${bankList}</span> BDT: ${addMoney} was added to your account, and your new balance is BDT: ${newBalance}</p>
