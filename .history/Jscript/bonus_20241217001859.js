       ...
       const transactionDiv = document.createElement('div');
               ...
               transactionDiv.innerHTML = `
                   <div class = "flex justify-between items-center gap-1">
                       ...
                       <div class="flex-1">
                       <p class="text-md"><span class ="font-bold text-green-600">You got BDT ${bonusAmount.toFixed(2)}</span> bonus on usage added to your account, and your new balance is BDT: ${newBalance.toFixed(2)}.</p>
